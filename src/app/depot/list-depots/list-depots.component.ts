...
export class ListDepotsComponent implements OnInit {
  ...
  counter!:number;
  constructor(private app:AppComponent, private gestionDepotService:GestionDepotService, private productService:ProductService,private fb:FormBuilder,private router:Router) { }
